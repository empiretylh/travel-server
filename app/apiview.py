...
class PackageAdmin(APIView):
    ...
    def post(self,request):
        ...
        package =  models.Package.objects.create(user=user,destination=destination,image=image,cost=cost,duration=duration)
...
class IncludePlace(APIView):
    ...
    def post(self,request):
        ...
        ip = models.IncludePlace.objects.create(user=user,package__id=packageid,placename=placename,hotels=hotels,lengthofstay=lengthofstay,image=image)
    ...
    def put(self,request,format=None):
        ...
        ip = models.IncludePlace.objects.get(id=ipid,user=user,package__id=packageid)
